...
addons_url_list = [
    ...
    "https://github.com/kodi1/plugin.video.mytvbg/archive/master.zip",
    ...
    "https://github.com/mancuniancol/script.pulsar.arenabg-mc/archive/master.zip",
    "https://github.com/mancuniancol/script.pulsar.rarbg-mc/archive/master.zip",
    "https://github.com/kodi1/plugin.video.bscfusion/archive/release.zip",
  ]
